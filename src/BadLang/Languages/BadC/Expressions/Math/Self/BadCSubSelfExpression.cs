...
public class BadCSubSelfExpression : BadCBinaryExpression
{

    #region Public

    public BadCSubSelfExpression( BadCExpression left, BadCExpression right, SourceToken token ) : base(
         left,
         right,
         token
        )
    ...
    {
        return new BadCSubSelfExpression(
