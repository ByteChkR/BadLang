...
public class BadCDivSelfExpression : BadCBinaryExpression
{

    #region Public

    public BadCDivSelfExpression( BadCExpression left, BadCExpression right, SourceToken token ) : base(
         left,
         right,
         token
        )
    ...
    {
        return new BadCDivSelfExpression(
