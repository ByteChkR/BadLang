...
public class BadCPreFixDecrementExpression : BadCExpression
{
    ...
    public BadCPreFixDecrementExpression( BadCExpression left, SourceToken token ) : base( false, token )
    {
        Left = left;
    }
    ...
    {
        return new BadCPreFixDecrementExpression(
