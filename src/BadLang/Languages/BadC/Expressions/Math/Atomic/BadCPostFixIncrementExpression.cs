...
public class BadCPostFixIncrementExpression : BadCExpression
{
    ...
    public BadCPostFixIncrementExpression( BadCExpression left, SourceToken token ) : base( false, token )
    {
        Left = left;
    }
    ...
    {
        return new BadCPostFixIncrementExpression(
