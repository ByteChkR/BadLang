...
public class BadCSubExpression : BadCBinaryExpression
{

    #region Public

    public BadCSubExpression( BadCExpression left, BadCExpression right, SourceToken token ) : base(
         left,
         right,
         token
        )
