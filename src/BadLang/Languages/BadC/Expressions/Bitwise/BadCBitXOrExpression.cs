...
public class BadCBitXOrExpression : BadCBinaryExpression
{

    #region Public

    public BadCBitXOrExpression( BadCExpression left, BadCExpression right, SourceToken token ) : base(
         left,
         right,
         token
        )
    ...
    {
        return new BadCBitXOrExpression(
