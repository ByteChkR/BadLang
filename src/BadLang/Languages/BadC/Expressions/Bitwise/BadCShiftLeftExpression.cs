...
public class BadCShiftLeftExpression : BadCBinaryExpression
{

    #region Public

    public BadCShiftLeftExpression( BadCExpression left, BadCExpression right, SourceToken token ) : base(
         left,
         right,
         token
        )
    ...
    {
        return new BadCShiftLeftExpression(
