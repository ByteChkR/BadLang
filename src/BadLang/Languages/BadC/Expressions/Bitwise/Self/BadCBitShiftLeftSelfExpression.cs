...
public class BadCBitShiftLeftSelfExpression : BadCBinaryExpression
{

    #region Public

    public BadCBitShiftLeftSelfExpression( BadCExpression left, BadCExpression right, SourceToken token ) :
        ...
        bool isLval )
    {
        ...
        context.Writer.Shl( baseTypeHint );
    ...
    {
        return new BadCBitShiftLeftSelfExpression(
                                                  Left.ResolveTemplateTypes(
                                                                            templateContext
                                                                           ),
                                                  Right.ResolveTemplateTypes(
                                                                             templateContext
                                                                            ),
                                                  SourceToken
                                                 );
