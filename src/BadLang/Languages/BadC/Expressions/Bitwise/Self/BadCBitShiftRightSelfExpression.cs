...
public class BadCBitShiftRightSelfExpression : BadCBinaryExpression
{

    #region Public

    public BadCBitShiftRightSelfExpression( BadCExpression left, BadCExpression right, SourceToken token ) :
    ...
    {
        return new BadCBitShiftRightSelfExpression(
