...
public class BadCBitAndSelfExpression : BadCBinaryExpression
{

    #region Public

    public BadCBitAndSelfExpression( BadCExpression left, BadCExpression right, SourceToken token ) :
    ...
    {
        return new BadCBitAndSelfExpression(
