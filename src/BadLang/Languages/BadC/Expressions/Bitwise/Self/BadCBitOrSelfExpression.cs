...
public class BadCBitOrSelfExpression : BadCBinaryExpression
{

    #region Public

    public BadCBitOrSelfExpression( BadCExpression left, BadCExpression right, SourceToken token ) : base(
         left,
         right,
         token
        )
    ...
    {
        return new BadCBitOrSelfExpression(
