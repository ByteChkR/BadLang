...
public class BadCLessOrEqualExpression : BadCBinaryExpression
{

    #region Public

    public BadCLessOrEqualExpression( BadCExpression left, BadCExpression right, SourceToken token ) :
        ...
        bool isLval )
    {
        ...
        context.Writer.BranchLessOrEqual( baseTypeHint, trueLabel );
    ...
    {
        return new BadCLessOrEqualExpression(
