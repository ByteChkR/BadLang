...
public class BadCLessThanExpression : BadCBinaryExpression
{

    #region Public

    public BadCLessThanExpression( BadCExpression left, BadCExpression right, SourceToken token ) : base(
         left,
         right,
         token
        )
        ...
        bool isLval )
    {
        ...
        context.Writer.BranchLess( baseTypeHint, trueLabel );
    ...
    {
        return new BadCLessThanExpression(
