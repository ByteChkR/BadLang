...
public class BadCGreaterThanExpression : BadCBinaryExpression
{

    #region Public

    public BadCGreaterThanExpression( BadCExpression left, BadCExpression right, SourceToken token ) :
        ...
        bool isLval )
    {
        ...
        context.Writer.BranchGreater( baseTypeHint, trueLabel );
    ...
    {
        return new BadCGreaterThanExpression(
