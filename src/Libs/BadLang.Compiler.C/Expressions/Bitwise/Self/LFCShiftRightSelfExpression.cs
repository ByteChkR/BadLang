...
public class LFCShiftRightSelfExpression : LFCShiftRightExpression
{
    public LFCShiftRightSelfExpression(LFCExpression left, LFCExpression right) : base(left, right) { }

    public override string GetOperatorName()
    {
        return "op_ShiftRightSelf";
    }
    ...
    {
        return new LFCShiftRightSelfExpression(rebuilder(Left), rebuilder(Right));
    }
