...
public class LFCShiftLeftSelfExpression : LFCShiftLeftExpression
{
    public LFCShiftLeftSelfExpression(LFCExpression left, LFCExpression right) : base(left, right) { }

    public override string GetOperatorName()
    {
        return "op_ShiftLeftSelf";
    }
    ...
    {
        return new LFCShiftLeftSelfExpression(rebuilder(Left), rebuilder(Right));
    }
