...
public class LFCXorSelfExpression : LFCXorExpression
{
    public LFCXorSelfExpression(LFCExpression left, LFCExpression right) : base(left, right) { }
    ...
    {
        return new LFCXorSelfExpression(rebuilder(Left), rebuilder(Right));
    }
