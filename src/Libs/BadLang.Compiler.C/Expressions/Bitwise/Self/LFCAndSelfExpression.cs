...
public class LFCAndSelfExpression : LFCAndExpression
{
    public LFCAndSelfExpression(LFCExpression left, LFCExpression right) : base(left, right) { }
    ...
    {
        return new LFCAndSelfExpression(rebuilder(Left), rebuilder(Right));
    }
