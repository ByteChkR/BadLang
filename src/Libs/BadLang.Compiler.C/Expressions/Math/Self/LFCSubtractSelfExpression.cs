...
public class LFCSubtractSelfExpression : LFCSubtractExpression
{
    public LFCSubtractSelfExpression(LFCExpression left, LFCExpression right) : base(left, right) { }
    ...
    {
        return new LFCSubtractSelfExpression(rebuilder(Left), rebuilder(Right));
    }
