...
namespace LF.Compiler.C.Expressions.Math.Self;

public class LFCMultiplySelfExpression : LFCMultiplyExpression
{
    public LFCMultiplySelfExpression(LFCExpression left, LFCExpression right) : base(left, right) { }
    ...
    {
        return new LFCMultiplySelfExpression(rebuilder(Left), rebuilder(Right));
    }
