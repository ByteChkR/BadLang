...
public class LFCDivideSelfExpression : LFCDivideExpression
{
    public LFCDivideSelfExpression(LFCExpression left, LFCExpression right) : base(left, right) { }
    ...
    {
        return new LFCDivideSelfExpression(rebuilder(Left), rebuilder(Right));
    }
