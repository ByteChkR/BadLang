...
public class LFCModuloSelfExpression : LFCModuloExpression
{
    public LFCModuloSelfExpression(LFCExpression left, LFCExpression right) : base(left, right) { }
    ...
    {
        return new LFCAddSelfExpression(rebuilder(Left), rebuilder(Right));
    }
