...
public class LFCPreValueDecrementExpression : LFCExpression
{
    private readonly LFCExpression Left;

    public LFCPreValueDecrementExpression(LFSourcePosition position, LFCExpression left) : base(position)
    {
        Left = left;
    }
    ...
    {
        return new LFCPreValueDecrementExpression(Position, rebuilder(Left));
    }
}