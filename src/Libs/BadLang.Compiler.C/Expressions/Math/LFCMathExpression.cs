...
public abstract class LFCMathExpression : LFCBinaryExpression
{
    private readonly OpCodes m_OpCode;
    private readonly string m_Symbol;

    protected LFCMathExpression(LFCExpression left, LFCExpression right, string symbol, OpCodes op8) : base(left, right)
    {
        m_Symbol = symbol;
        m_OpCode = op8;
    }
    ...
    protected LFCExpressionCompileResult Compile(LFCExpressionCompileInput input, LFCExpressionCompileResult leftResult, LFCExpressionCompileResult rightResult)
    {
    ...
    public override LFCExpressionCompileResult Compile(LFCExpressionCompileInput input)
    {
        ...
        return Compile(input, leftResult, rightResult);
    }
}